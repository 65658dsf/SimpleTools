...
Keep all four tools usable at `/convert`, `/compress`, `/watermark`, and `/pdf`. Every queue state
must have a visible loading, success, failure, retry, and cancellation representation. New backend
