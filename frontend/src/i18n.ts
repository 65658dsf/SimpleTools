...
const messages = {
  ...
  zh: {
    ...
    theme: '主题', language: '语言', light: '浅色', dark: '深色', system: '跟随系统', targetBytes: '目标字节数（0 表示关闭）', pageRange: '页码，例如 1-3,5', cancel: '取消', supported: '支持类型', imageTypes: 'JPG、PNG、WEBP、AVIF、ICO、SVG', pdfType: 'PDF 文档', outputPlaceholder: '默认：软件目录/output，可选择其他目录', saved: '保存在本地',
  },
}
