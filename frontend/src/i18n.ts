...
const messages = {
  en: {
    ...
    convertDesc: 'Change image formats in a few clicks.', compressDesc: 'Reduce file size while keeping quality.', watermarkDesc: 'Add a styled text watermark while keeping the source format.', qrcodeDesc: 'Turn text or links into a customizable PNG QR code.', pdfDesc: 'Render each PDF page as a crisp PNG.',
  ...
  zh: {
    ...
    convert: '图片转换', compress: '图片压缩', watermark: '图片水印', qrcode: '文本生成二维码', pdf: 'PDF 转 PNG', convertDesc: '几步即可转换图片格式。', compressDesc: '在保持质量的同时减小文件体积。', watermarkDesc: '自定义文本与样式，为图片添加水印并保留原格式。', qrcodeDesc: '将文本或链接生成可自定义的 PNG 二维码。', pdfDesc: '将每一页 PDF 渲染为清晰 PNG。',
